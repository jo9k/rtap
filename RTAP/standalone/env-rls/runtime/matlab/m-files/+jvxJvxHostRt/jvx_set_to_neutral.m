...
if(a)
    ...
    if(~a)
        ...
        sequence_status = jvxJvxHost.jvx_create_tables('jvxSequencerStatus');
        state_init_sequencer =  jvxJvxHost.jvx_lookup_type_id__name(sequence_status, 'JVX_SEQUENCER_STATUS_NONE');
