% Matlab file for accessing (get) property engage
...
function [out] = get_audio_property_node_engage()
	out = [];
	global jvx_host_call_global;
	try
		[p0 p1] = jvx_host_call_global('get_property_descriptor', 'JVX_COMPONENT_AUDIO_NODE', 'engage');
		if(~p0)
