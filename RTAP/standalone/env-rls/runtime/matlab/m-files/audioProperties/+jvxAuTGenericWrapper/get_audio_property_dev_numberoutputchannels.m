...
function [out] = get_audio_property_dev_numberoutputchannels()
	out = [];
	global jvx_host_call_global;
	try
		[p0 p1] = jvx_host_call_global('get_property_descriptor', 'JVX_COMPONENT_AUDIO_DEVICE', 'numberoutputchannels');
		if(~p0)
