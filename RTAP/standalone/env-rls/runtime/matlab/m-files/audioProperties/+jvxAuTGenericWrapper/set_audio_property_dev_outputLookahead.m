% Matlab file for accessing (set) property outputLookahead
% Property related to entry in property description file unknown, starting in line -1
function set_audio_property_dev_outputLookahead(in)
	global jvx_host_call_global;
	try
		[p0 p1] = jvx_host_call_global('set_property_descriptor', 'JVX_COMPONENT_AUDIO_DEVICE', 'JVX_GENW_OUTFILE_LAHEAD', int16(in));
		if(~p0)
