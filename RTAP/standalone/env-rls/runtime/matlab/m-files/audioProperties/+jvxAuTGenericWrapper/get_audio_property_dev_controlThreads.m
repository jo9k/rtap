% Matlab file for accessing (get) property controlThreads
...
function [out] = get_audio_property_dev_controlThreads()
	out = [];
	global jvx_host_call_global;
	try
		[p0 p1] = jvx_host_call_global('get_property_descriptor', 'JVX_COMPONENT_AUDIO_DEVICE', 'controlThreads');
		if(~p0)
