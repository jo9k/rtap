...
public:
	...
	virtual jvxErrorType JVX_CALLINGCONVENTION  activate(const char* fName, jvxEndpointDescription descr, jvxFileDescriptionEndpoint_open* fileDescr) = 0;
	...
	virtual jvxErrorType JVX_CALLINGCONVENTION  add_audio_buffer(void** buffers, jvxSize numberChannels, jvxSize numberSamples, jvxBool strictlyNoBlocking) = 0;
	...
	virtual jvxErrorType JVX_CALLINGCONVENTION  set_properties_file(jvxSize* numChannels, jvxInt32* samplerate,
		jvxDataFormat* format_file, jvxEndpointDescription* endpoint_description) = 0;
