...
public:
  virtual JVX_CALLINGCONVENTION ~IjvxDataLogger(){};
	...
	virtual jvxErrorType JVX_CALLINGCONVENTION initialize(jvxSize numberBytesBuffer, jvxSize szDataFieldWriteAtOnce ) = 0;
	...
	virtual jvxErrorType JVX_CALLINGCONVENTION filename(jvxString** fName) = 0;
