...
public:
	...
	virtual jvxErrorType JVX_CALLINGCONVENTION fill_empty(jvxExternalDataType** plhs, jvxInt32 nlhs, jvxSize offset) = 0;
	...
	virtual jvxErrorType JVX_CALLINGCONVENTION convertExternalToC(jvxString** textInput, const jvxExternalDataType* ptr, const char* nameVar = "") = 0;
	...
	virtual jvxErrorType JVX_CALLINGCONVENTION getLastErrorReason(jvxString** errStr) = 0;

	//! If an jvxString has been returned, the returned string can be released by calling this function
	virtual jvxErrorType JVX_CALLINGCONVENTION releaseString(jvxString* errStr) = 0;
