...
public:
	...
	virtual jvxErrorType JVX_CALLINGCONVENTION description_input(jvxSize idx, jvxString** str) = 0;
	...
	virtual jvxErrorType JVX_CALLINGCONVENTION description_output(jvxSize idx, jvxString** str) = 0;
