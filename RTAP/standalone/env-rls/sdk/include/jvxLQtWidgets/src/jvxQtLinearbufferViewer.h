#ifndef _H_JVXQTLINEARBUFFERVIEWER_H__
#define _H_JVXQTLINEARBUFFERVIEWER_H__
...
#include "jvxQtWidgetsCommon.h"

class jvxQtLinearbufferViewer: public QWidget
{
public:
	...
	typedef struct
	{
		...
		jvx_propertyReferenceTriple theProps;
...
private:
	...
	jvxQtWidgetsCommonConfigure myConfig;
	configurePropertyInterface myProperties;
	jvxState myState;

	struct
	{
		oneMultichannelCircBufferHeader* fld;
		jvxSize sz;
		jvxBool isValid;
	} theCircHeader;

public:
	jvxQtLinearbufferViewer(QWidget* parent);
	~jvxQtLinearbufferViewer();

	jvxErrorType init(jvxQtWidgetsCommonConfigure* theViewerConfig);
