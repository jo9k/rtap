...
jvx_resampler_plotter_process(jvxData in,
			 jvxData* out_min, jvxData* out_max, jvxBool* outputProduced,
...
jvx_resampler_plotter_process_reconfig(jvxData in,
			 jvxData* out_min, jvxData* out_max, jvxBool* outputProduced,
			 resampler_plotter_private* handle, jvxData downSampleFac, jvxBool* wasReconfigured)
{
	jvxData accuOut = 0;
...
inline jvxDspBaseErrorType
jvx_resampler_plotter_predict(jvxBool* nextTimeInput, jvxBool* nextTimeOutput, resampler_plotter_private* handle)
{
