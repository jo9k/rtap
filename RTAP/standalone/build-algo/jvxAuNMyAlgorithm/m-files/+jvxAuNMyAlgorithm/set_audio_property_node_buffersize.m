% Matlab file for accessing (set) property buffersize
% Property related to entry in property description file unknown, starting in line -1
function set_audio_property_node_buffersize(in)
	global jvx_host_call_global;
	try
		[p0 p1] = jvx_host_call_global('set_property_descriptor', 'JVX_COMPONENT_AUDIO_NODE', 'JVX_AUDIONODE_BUFFERSIZE', int32(in));
		if(~p0)
