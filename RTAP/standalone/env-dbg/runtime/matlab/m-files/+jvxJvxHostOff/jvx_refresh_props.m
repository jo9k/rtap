...
if(a)
    ...
    if(info.STATE_INT32 == id_check_active)
        ...
        bset_feature_external_call = jvxJvxHost.jvx_lookup_type_id__name(handles.jvx_struct.tables.feature_class_bitsets, 'JVX_FEATURE_CLASS_EXTERNAL_CALL');
        ...
        % calls is supported
        [handles.jvx_struct.properties.node.state, handles.jvx_struct.properties.node.id, handles.jvx_struct.properties.node.feature_ext_call_audio_node] = jvxJvxHost.jvx_find_state_components(handles, info.COMPONENTS.AUDIO_NODE, bset_feature_external_call);
