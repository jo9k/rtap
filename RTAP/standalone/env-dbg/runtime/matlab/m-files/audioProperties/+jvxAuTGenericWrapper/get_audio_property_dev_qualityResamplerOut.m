% Matlab file for accessing (get) property qualityResamplerOut
...
function [out] = get_audio_property_dev_qualityResamplerOut()
	out = [];
	global jvx_host_call_global;
	try
		[p0 p1] = jvx_host_call_global('get_property_descriptor', 'JVX_COMPONENT_AUDIO_DEVICE', 'JVX_GENW_DEV_QRESAMPLER_OUT');
		if(~p0)
