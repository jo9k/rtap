% Matlab file for accessing (get) property autoOff
...
function [out] = get_audio_property_dev_autoOff()
	out = [];
	global jvx_host_call_global;
	try
		[p0 p1] = jvx_host_call_global('get_property_descriptor', 'JVX_COMPONENT_AUDIO_DEVICE', 'JVX_GENW_AUTO_OFF');
		if(~p0)
