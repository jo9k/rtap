% Matlab file for accessing (set) property triggerRestart
% Property related to entry in property description file unknown, starting in line -1
function set_audio_property_dev_triggerRestart(in)
	global jvx_host_call_global;
	try
		[p0 p1] = jvx_host_call_global('set_property_descriptor', 'JVX_COMPONENT_AUDIO_DEVICE', 'JVX_GENW_INFILE_RESTART', int16(in));
		if(~p0)
