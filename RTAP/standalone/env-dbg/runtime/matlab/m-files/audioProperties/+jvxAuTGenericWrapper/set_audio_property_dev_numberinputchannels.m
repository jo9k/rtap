...
function set_audio_property_dev_numberinputchannels(in)
	global jvx_host_call_global;
	try
		[p0 p1] = jvx_host_call_global('set_property_descriptor', 'JVX_COMPONENT_AUDIO_DEVICE', 'numberinputchannels', int32(in));
		if(~p0)
