% Matlab file for accessing (set) property qualityResamplerIn
...
function set_audio_property_dev_qualityResamplerIn(in)
	global jvx_host_call_global;
	try
		[p0 p1] = jvx_host_call_global('set_property_descriptor', 'JVX_COMPONENT_AUDIO_DEVICE', 'JVX_GENW_DEV_QRESAMPLER_IN', (in));
		if(~p0)
