% Matlab file for accessing (set) property setupAsync
% Property related to entry in property description file unknown, starting in line -1
% Selection 0x1(1): async
% Selection 0x2(2): sync
function set_audio_property_dev_setupAsync(in)
	global jvx_host_call_global;
	try
		[p0 p1] = jvx_host_call_global('set_property_descriptor', 'JVX_COMPONENT_AUDIO_DEVICE', 'JVX_GENW_DEV_REBUFFER', (in));
		if(~p0)
