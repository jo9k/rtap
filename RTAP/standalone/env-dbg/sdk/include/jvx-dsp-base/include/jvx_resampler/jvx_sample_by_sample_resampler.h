...
jvx_sample_by_sample_resampler_process(jvxData in, jvxData* out,
			 jvxBool* inputConsumed, jvxBool* outputProduced,
...
jvxDspBaseErrorType
jvx_sample_by_sample_resampler_modifyPhase(jvxInt32 modPhase, jvxInt32* modPhase_done, jvxBool actOnInput, sample_by_sample_resampler_private* handle);

inline jvxDspBaseErrorType
jvx_sample_by_sample_resampler_predict(jvxBool* nextTimeInput, jvxBool* nextTimeOutput, sample_by_sample_resampler_private* handle)
{
