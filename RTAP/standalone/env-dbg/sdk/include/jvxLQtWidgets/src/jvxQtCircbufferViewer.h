#ifndef _H_JVXQTCIRCBUFFERVIEWER_H__
#define _H_JVXQTCIRCBUFFERVIEWER_H__
...
class jvxQtCircbufferViewer: public QWidget
{
public:
...
public:
	jvxQtCircbufferViewer(QWidget* parent);
	~jvxQtCircbufferViewer();
