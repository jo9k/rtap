#ifndef _H_JVXQTTDBUFFERVIEWER_H__
#define _H_JVXQTTDBUFFERVIEWER_H__
...
class jvxQtTDBufferViewer: public QWidget
{
public:
...
private:
	...
	configureBufferViewer myConfig;
...
public:
	jvxQtTDBufferViewer(QWidget* parent);
	~jvxQtTDBufferViewer();

	jvxErrorType init(configureBufferViewer* theViewerConfig);
