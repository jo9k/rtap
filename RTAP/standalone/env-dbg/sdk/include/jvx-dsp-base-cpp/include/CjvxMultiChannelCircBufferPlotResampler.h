...
protected:
	...
	struct
	{
		...
		oneMultichannelCircBufferHeader* theEndpoint;
...
protected:
	...
	jvxErrorType set_endpoint_circbuffer(oneMultichannelCircBufferHeader* endpoint);
	...
	jvxErrorType process_circbuffer(jvxData** samples);
...
private:
	...
	static jvxErrorType st_callback_thread_timer_expired(jvxHandle* privateData_thread, jvxInt64 timestamp_us);
	static jvxErrorType st_callback_thread_wokeup(jvxHandle* privateData_thread, jvxInt64 timestamp_us);
