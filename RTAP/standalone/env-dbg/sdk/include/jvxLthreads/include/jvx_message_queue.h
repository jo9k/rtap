...
jvxErrorType jvx_message_queue_initialize(jvxHandle** hdlOnReturn, jvxMessageQueueObjectStrategyType type, messageQueueHandler* report_callback, jvxHandle* privData, 
		jvxSize numMessagesInQueueMax, jvxInt32 timeoutMax_ms, bool transmit_timestamp, jvxSize maxSizeContainerMessage);
...
jvxErrorType jvx_message_queue_clear_queue(jvxHandle* hdl);
