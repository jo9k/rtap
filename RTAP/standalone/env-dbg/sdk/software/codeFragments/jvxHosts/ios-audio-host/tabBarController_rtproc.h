...
@property (assign) jvxBool showWrappedFormats;
...
@property (assign) jvxBool doResample;
@property (assign) jvxBool doRebuffer;
...
@property (assign) jvxBool statusIsRunning;
...
- (void) refreshTitles;
- (void) refreshLocalTitles:(jvxBool)removeList;
- (void) update_local_infiles;
- (NSString*) idInInputFileListTech: (jvxBool) removeLust
