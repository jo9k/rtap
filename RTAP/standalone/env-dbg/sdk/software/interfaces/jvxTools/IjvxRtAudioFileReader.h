...
public:	
	...
	virtual jvxErrorType JVX_CALLINGCONVENTION get_tag(jvxAudioFileTagType tp, jvxString** val) = 0;
	...
	//! Return the number of channels involved
		...
		jvxDataFormat* format_file, jvxEndpointDescription* endpoint_description, 
		jvxSize* length_file) = 0;
