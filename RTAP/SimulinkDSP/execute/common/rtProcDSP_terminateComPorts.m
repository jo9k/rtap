% Function to set the system and all COM ports to uninitialized state
% when processing is over.
%
% Syntax: [success, structSetup] = rtProcDSP_terminateComPorts();
%
...
%%
function [success, structSetup] = rtProcDSP_terminateComPorts();

% Call function through MEX gateway and command ID 0
[success, structSetup] = dspDebug(1);
