...
5) Make sure you are in the execute - simulink - fir directory.
...
8) Once this simulation is over, the filter coefficients will remain as specified (LP, HP or BP). This
   is also audible in the output signal.
